...
<!-- 트렌드 레이더 (일요일 전용) -->
<div style="margin-bottom:28px;">
  <div class="section-title" style="color:var(--trend, #a78bfa);">🔭 트렌드 레이더 <span style="font-size:0.75rem; color:var(--muted); font-weight:400;">— 3~6개월 선행 테마 포착</span></div>
  <div class="trend-card" style="display:flex; flex-direction:column; gap:12px;">
    <div class="trend-item" style="background:var(--card); border:1px solid var(--border); border-radius:10px; padding:14px 16px;">
      <div class="trend-signal" style="font-size:0.75rem; font-weight:700; color:var(--accent); margin-bottom:6px;">📡 신호 #1 <span style="background:rgba(167,139,250,0.15); color:#a78bfa; border:1px solid rgba(167,139,250,0.3); border-radius:4px; padding:2px 8px; font-size:0.68rem;">[[단기|중기|장기]]</span></div>
      <div style="font-size:0.82rem; color:var(--text); line-height:1.6; margin-bottom:8px;">[[3~6개월 선행 테마 — 구체적 수치+근거+투자 연결고리]]</div>
      <div style="font-size:0.75rem; color:#a78bfa; font-weight:600;">📌 수혜 ETF/섹터: [[ETF명 또는 섹터]]</div>
    </div>
    <div class="trend-item" style="background:var(--card); border:1px solid var(--border); border-radius:10px; padding:14px 16px;">
      <div class="trend-signal" style="font-size:0.75rem; font-weight:700; color:var(--accent); margin-bottom:6px;">📡 신호 #2 <span style="background:rgba(167,139,250,0.15); color:#a78bfa; border:1px solid rgba(167,139,250,0.3); border-radius:4px; padding:2px 8px; font-size:0.68rem;">[[단기|중기|장기]]</span></div>
      <div style="font-size:0.82rem; color:var(--text); line-height:1.6; margin-bottom:8px;">[[3~6개월 선행 테마 — 구체적 수치+근거+투자 연결고리]]</div>
      <div style="font-size:0.75rem; color:#a78bfa; font-weight:600;">📌 수혜 ETF/섹터: [[ETF명 또는 섹터]]</div>
    </div>
    <div class="trend-item" style="background:var(--card); border:1px solid var(--border); border-radius:10px; padding:14px 16px;">
      <div class="trend-signal" style="font-size:0.75rem; font-weight:700; color:var(--accent); margin-bottom:6px;">📡 신호 #3 <span style="background:rgba(167,139,250,0.15); color:#a78bfa; border:1px solid rgba(167,139,250,0.3); border-radius:4px; padding:2px 8px; font-size:0.68rem;">[[단기|중기|장기]]</span></div>
      <div style="font-size:0.82rem; color:var(--text); line-height:1.6; margin-bottom:8px;">[[3~6개월 선행 테마 — 구체적 수치+근거+투자 연결고리]]</div>
      <div style="font-size:0.75rem; color:#a78bfa; font-weight:600;">📌 수혜 ETF/섹터: [[ETF명 또는 섹터]]</div>
    </div>
  </div>
