...
from data_collector import collect_market_data, collect_portfolio_data
...
if sheet_id:
    ...
    portfolio_json = "{}"
    print("⚠️ PORTFOLIO_SHEET_ID 없음 — 포트폴리오 섹션 생략")
...
prompt = prompt.replace("[[PORTFOLIO_JSON]]", portfolio_json)
