...
- 트렌드 레이더는 오늘 뉴스 재탕 금지 — 반드시 3~6개월 선행 관점으로만 작성
...
★ 트렌드 레이더 작성:
- 오늘 뉴스 재탕 절대 금지. 3~6개월 후 시장 테마를 선행 포착하는 것이 목적
- 각 항목: 글로벌 신호 → 한국 수혜 ETF/섹터 연결까지 명시
- 예시: "엔비디아 실적에서 'Sovereign AI' 12번 언급 → 각국 정부 AI 인프라 발주 확대 → 전력·냉각·네트워크 장비 섹터 선행 매수 구간 / 수혜: TIGER 전력기기·KODEX K-신재생에너지"
...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .risk-divider { grid-column: 1 / -1; border-top: 1px dashed var(--border); padding-top: 6px; font-size: 0.7rem; color: var(--muted); font-weight: 600; letter-spacing: 0.5px; }
  ...
  .badge-kr { background: rgba(88,166,255,0.15); color: var(--accent); border: 1px solid rgba(88,166,255,0.3); }
  .badge-trend { background: rgba(163,113,247,0.15); color: var(--trend); border: 1px solid rgba(163,113,247,0.3); }
  ...
  /* 트렌드 레이더 */
  .trend-card { background: linear-gradient(135deg, #161b22 0%, #1a1535 100%); border: 1px solid rgba(163,113,247,0.3); border-radius: 12px; padding: 20px 22px; }
  .trend-item { background: rgba(0,0,0,0.3); border: 1px solid rgba(163,113,247,0.2); border-radius: 10px; padding: 14px 16px; margin-bottom: 10px; }
  .trend-item:last-child { margin-bottom: 0; }
  .trend-signal { font-size: 0.7rem; font-weight: 700; color: var(--trend); text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 6px; }
  .trend-body { font-size: 0.82rem; color: var(--text); line-height: 1.6; }
  .trend-etf { display: inline-block; margin-top: 8px; font-size: 0.72rem; font-weight: 700; color: var(--trend); background: rgba(163,113,247,0.1); border: 1px solid rgba(163,113,247,0.3); border-radius: 6px; padding: 3px 10px; }
  .trend-horizon { display: inline-block; font-size: 0.68rem; color: var(--muted); background: rgba(255,255,255,0.05); border-radius: 4px; padding: 2px 7px; margin-left: 6px; }
  /* 한국 수급 */
  .kr-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 14px; margin-bottom: 14px; }
  @media (max-width: 600px) { .kr-grid { grid-template-columns: 1fr; } }
  .sector-row { display: grid; grid-template-columns: repeat(3, 1fr); gap: 8px; }
  .sector-box { background: #0d1117; border-radius: 8px; padding: 10px; border: 1px solid var(--border); }
  .sector-box .slabel { font-size: 0.68rem; color: var(--muted); margin-bottom: 4px; }
...
<div class="grid-4" style="margin-bottom:28px;">
  ...
  <div class="card">
    ...
    <div class="value [[up|down|neutral]]">[[지수값]]</div>
    <div class="change [[up|down|neutral]]">[[▲|▼]] [[등락률%]]</div>
    <div class="sub">외국인 [[순매수|순매도]] [[금액]]억 · 기관 [[순매수|순매도]] [[금액]]억</div>
  </div>
  <div class="card">
    <div class="label">💵 USD/KRW</div>
    <div class="value [[up|down|neutral]]">[[환율]]원</div>
    <div class="change [[up|down|neutral]]">[[▲|▼]] [[변동폭]]원</div>
    <div class="sub">[[원화 강약 방향 + 외국인 수급 영향]]</div>
  </div>
</div>
...
<div style="margin-bottom:28px;">
  ...
  <div class="btc-main">
    <div style="display:flex; justify-content:space-between; align-items:flex-start; flex-wrap:wrap; gap:20px; margin-bottom:20px;">
      <div>
        <div style="font-size:0.75rem; color:var(--muted); text-transform:uppercase; letter-spacing:0.8px; margin-bottom:10px;">BTC / KRW · CoinGecko 기준</div>
      ...
      <div style="display:flex; flex-direction:column; gap:8px; align-items:flex-end;">
        ...
        <div style="background:rgba(210,153,34,0.12); border:1px solid rgba(210,153,34,0.3); border-radius:8px; padding:8px 14px; text-align:center;">
          <div style="font-size:0.68rem; color:var(--muted);">크립토 공포탐욕</div>
          <div style="font-size:1.3rem; font-weight:800; color:var(--warn);">[[크립토_공포탐욕]]</div>
          <div style="font-size:0.68rem; color:var(--warn); font-weight:600;">[[극도공포|공포|중립|탐욕]]</div>
        </div>
      </div>
    </div>
    <div class="btc-meta">
...
<!-- 리스크 체크리스트: 글로벌 5 + 한국 3 -->
<div style="margin-bottom:28px;">
  <div class="section-title">🎯 리스크 체크리스트</div>
  <div class="risk-grid">
    <!-- 글로벌 5개 -->
    <div class="risk-divider">🌐 글로벌</div>
    <div class="risk-item">
      <div class="dot [[dot-red|dot-yellow|dot-green]]"></div>
      <div><div class="risk-label">① [[글로벌 리스크 제목]]</div><div class="risk-desc">[[설명 + 수치]]</div></div>
    </div>
    <div class="risk-item">
      <div class="dot [[dot-red|dot-yellow|dot-green]]"></div>
      <div><div class="risk-label">② [[글로벌 리스크 제목]]</div><div class="risk-desc">[[설명 + 수치]]</div></div>
    ...
    <!-- 한국 3개 -->
    <div class="risk-divider">🇰🇷 한국</div>
    <div class="risk-item">
      <div class="dot [[dot-red|dot-yellow|dot-green]]"></div>
      <div><div class="risk-label">⑥ 환율 리스크</div><div class="risk-desc">[[USD/KRW 현재값 + 원화 방향 + 외국인 수급 영향]]</div></div>
    </div>
    <div class="risk-item">
      <div class="dot [[dot-red|dot-yellow|dot-green]]"></div>
      <div><div class="risk-label">⑦ 반도체/수출 리스크</div><div class="risk-desc">[[삼성·하이닉스 이슈 + 수출 증감 + 미중 규제 동향]]</div></div>
    </div>
    <div class="risk-item">
      <div class="dot [[dot-red|dot-yellow|dot-green]]"></div>
      <div><div class="risk-label">⑧ 외국인 수급 리스크</div><div class="risk-desc">[[최근 N일 외국인 누적 순매수/도 + 방향성]]</div></div>
    </div>
  </div>
...
<!-- 한국 수급 현황 (숫자 중심, 텍스트 중복 금지) -->
<div style="margin-bottom:28px;">
  <div class="section-title">🇰🇷 한국 수급 현황</div>
  <div class="kr-grid">
    <div class="card">
      <div class="label">KOSPI 수급</div>
      <div class="value [[up|down|neutral]]">[[KOSPI지수]]</div>
      <div class="change [[up|down|neutral]]">[[▲|▼]] [[등락률%]] · [[등락포인트]]pt</div>
      <div class="sub" style="margin-top:8px;">외국인 <strong style="color:var(--[[up|down]]);">[[금액]]억</strong> · 기관 <strong style="color:var(--[[up|down]]);">[[금액]]억</strong> · 개인 [[금액]]억</div>
      <div class="sub">거래대금 [[금액]]조 · 52주 고점比 [[위치]]%</div>
    </div>
    <div class="card">
      <div class="label">KOSDAQ 수급</div>
      <div class="value [[up|down|neutral]]">[[KOSDAQ지수]]</div>
      <div class="change [[up|down|neutral]]">[[▲|▼]] [[등락률%]] · [[등락포인트]]pt</div>
      <div class="sub" style="margin-top:8px;">외국인 <strong style="color:var(--[[up|down]]);">[[금액]]억</strong> · 기관 <strong style="color:var(--[[up|down]]);">[[금액]]억</strong> · 개인 [[금액]]억</div>
      <div class="sub">[[KOSDAQ 특이사항]]</div>
    </div>
  </div>
  <div class="card">
    <div style="font-size:0.78rem; font-weight:700; color:var(--accent); margin-bottom:10px;">📈 오늘의 섹터 동향</div>
    <div class="sector-row">
      <div class="sector-box">
        <div class="slabel">강세 섹터</div>
        <div style="font-size:0.8rem; color:var(--up); font-weight:600;">[[섹터1]] [[+%]]</div>
        <div style="font-size:0.8rem; color:var(--up);">[[섹터2]] [[+%]]</div>
        <div style="font-size:0.8rem; color:var(--up);">[[섹터3]] [[+%]]</div>
      </div>
      <div class="sector-box">
        <div class="slabel">약세 섹터</div>
        <div style="font-size:0.8rem; color:var(--down); font-weight:600;">[[섹터1]] [[-%]]</div>
        <div style="font-size:0.8rem; color:var(--down);">[[섹터2]] [[-%]]</div>
        <div style="font-size:0.8rem; color:var(--down);">[[섹터3]] [[-%]]</div>
      </div>
      <div class="sector-box">
        <div class="slabel">주요 종목</div>
        <div style="font-size:0.78rem; color:var(--text);">[[삼성전자 등 시총 상위 등락]]</div>
      </div>
    </div>
  </div>
</div>

<!-- 핵심 이슈: 글로벌 3 + 한국 2 (뱃지로 구분) -->
<div style="margin-bottom:28px;">
  <div class="section-title">📰 이번 주 핵심 이슈</div>
  <div class="news-list">
    <!-- 글로벌 3개 -->
    <div class="news-item"><div class="news-text"><strong>🇺🇸 [[이슈1 제목]]</strong> — [[수치+투자관점+영향자산 2~3줄]]</div><span class="badge [[badge-neg|badge-pos|badge-neu]]">글로벌</span></div>
    <div class="news-item"><div class="news-text"><strong>🇺🇸 [[이슈2 제목]]</strong> — [[수치+투자관점+영향자산 2~3줄]]</div><span class="badge [[badge-neg|badge-pos|badge-neu]]">글로벌</span></div>
    <div class="news-item"><div class="news-text"><strong>🌐 [[이슈3 제목]]</strong> — [[수치+투자관점+영향자산 2~3줄]]</div><span class="badge [[badge-neg|badge-pos|badge-neu]]">글로벌</span></div>
    <!-- 한국 2개 (리스크 체크리스트·수급 섹션과 중복 금지) -->
    <div class="news-item"><div class="news-text"><strong>🇰🇷 [[한국이슈1 제목]]</strong> — [[수치+투자관점+영향자산 2~3줄]]</div><span class="badge badge-kr">한국</span></div>
    <div class="news-item"><div class="news-text"><strong>🇰🇷 [[한국이슈2 제목]]</strong> — [[수치+투자관점+영향자산 2~3줄]]</div><span class="badge badge-kr">한국</span></div>
  </div>
</div>

<!-- 트렌드 레이더 (3~6개월 선행, 오늘 뉴스 재탕 금지) -->
<div style="margin-bottom:28px;">
  <div class="section-title" style="color:var(--trend);">🔭 트렌드 레이더 <span style="font-size:0.75rem; color:var(--muted); font-weight:400;">— 3~6개월 선행 테마 포착</span></div>
  <div class="trend-card">
    <div class="trend-item">
      <div class="trend-signal">📡 신호 #1 <span class="trend-horizon">[[단기|중기|장기]]</span></div>
      <div class="trend-body">[[글로벌 신호 — 기관·VC 자금 흐름, 빅테크 키워드, 정책 동향 등 근거 포함 2~3줄]]</div>
      <div><span class="trend-etf">📌 수혜 ETF/섹터: [[한국 ETF명 또는 섹터]]</span></div>
    </div>
    <div class="trend-item">
      <div class="trend-signal">📡 신호 #2 <span class="trend-horizon">[[단기|중기|장기]]</span></div>
      <div class="trend-body">[[글로벌 신호 2 — 특허·채용공고·논문 증가 분야, 규제 동향 등 근거 포함 2~3줄]]</div>
      <div><span class="trend-etf">📌 수혜 ETF/섹터: [[한국 ETF명 또는 섹터]]</span></div>
    </div>
    <div class="trend-item">
      <div class="trend-signal">📡 신호 #3 <span class="trend-horizon">[[단기|중기|장기]]</span></div>
      <div class="trend-body">[[글로벌 신호 3 — 빅테크 실적 키워드, 소비 패턴 변화, 신흥국 동향 등 근거 포함 2~3줄]]</div>
      <div><span class="trend-etf">📌 수혜 ETF/섹터: [[한국 ETF명 또는 섹터]]</span></div>
    </div>
  </div>
</div>
...
==========================================================
[STEP 2] 웹 검색 — 아래 6개만 실행 (JSON에 없는 데이터)
각 검색 결과는 지정된 섹션에만 사용. 섹션 간 중복 기술 절대 금지.
==========================================================

1. "CNN Fear and Greed Index [[TODAY]]"
   → CNN 공포탐욕지수 숫자값 (상단 카드에만 사용)

2. "stock market news [[TODAY]]"
   → 글로벌 주요 뉴스 3개 (핵심 이슈 섹션 글로벌 3개에만 사용)

3. "economic calendar this week [[TODAY]]"
   → 이번 주 주요 경제 이벤트 (경제 캘린더에만 사용)

4. "코스피 코스닥 외국인 기관 수급 [[TODAY]]"
   → 외국인/기관 순매수(도) 금액, 섹터 동향 (한국 수급 현황에만 사용)

5. "한국 주식시장 주요 뉴스 [[TODAY]]"
   → 한국 이슈 2개 (핵심 이슈 섹션 한국 2개에만 사용)

6. "emerging tech trends investment 2026 AI robotics energy"
   → 기관·VC 자금 흐름, 빅테크 실적 키워드, 정책 동향 기반 차기 테마 3개
   → 각 테마별 한국 수혜 ETF/섹터 연결 (트렌드 레이더에만 사용)
   → 오늘 뉴스 재탕 금지 — 반드시 3~6개월 선행 관점으로만 작성
