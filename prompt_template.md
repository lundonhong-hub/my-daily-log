...
한국
🔭 트렌드 레이더 — 3~6개월 선행 테마 포착
📡 신호 #1 [[단기|중기|장기]]
[[글로벌 신호 — 기관·VC 자금 흐름, 빅테크 키워드, 정책 동향 등 근거 포함 2~3줄]]
📌 수혜 ETF/섹터: [[한국 ETF명 또는 섹터]]
📡 신호 #2 [[단기|중기|장기]]
[[글로벌 신호 2 — 특허·채용공고·논문 증가 분야, 규제 동향 등 근거 포함 2~3줄]]
📌 수혜 ETF/섹터: [[한국 ETF명 또는 섹터]]
📡 신호 #3 [[단기|중기|장기]]
[[글로벌 신호 3 — 빅테크 실적 키워드, 소비 패턴 변화, 신흥국 동향 등 근거 포함 2~3줄]]
📌 수혜 ETF/섹터: [[한국 ETF명 또는 섹터]]
📅 주요 경제 이벤트
...
========================================================== [STEP 2] 웹 검색 — 아래 6개만 실행 (JSON에 없는 데이터) 각 검색 결과는 지정된 섹션에만 사용. 섹션 간 중복 기술 절대 금지.
...
"emerging tech trends investment 2026 AI robotics energy" → 기관·VC 자금 흐름, 빅테크 실적 키워드, 정책 동향 기반 차기 테마 3개 → 각 테마별 한국 수혜 ETF/섹터 연결 (트렌드 레이더에만 사용) → 오늘 뉴스 재탕 금지 — 반드시 3~6개월 선행 관점으로만 작성
