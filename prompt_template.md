...
<div style="margin-bottom:28px;">
  <div class="section-title">🇰🇷 한국 주식시장 심층 분석</div>
  <!-- KOSPI/KOSDAQ 나란히 + 수급 -->
  <div style="display:grid; grid-template-columns:repeat(2,1fr); gap:14px; margin-bottom:14px;">
    <div class="card">
      <div class="label">🇰🇷 KOSPI 상세</div>
      <div class="value [[up|down|neutral]]">[[KOSPI지수]]</div>
      <div class="change [[up|down|neutral]]">[[▲|▼]] [[등락률%]] · [[등락포인트]]pt</div>
      <div class="sub" style="margin-top:8px;">외국인 [[순매수|순매도]] <strong style="color:var(--[[up|down]]);">[[금액]]억</strong> · 기관 [[순매수|순매도]] [[금액]]억</div>
      <div class="sub">거래대금 [[금액]]조 · [[52주 고점 대비 위치 및 코멘트]]</div>
    </div>
    <div class="card">
      <div class="label">📊 KOSDAQ 상세</div>
      <div class="value [[up|down|neutral]]">[[KOSDAQ지수]]</div>
      <div class="change [[up|down|neutral]]">[[▲|▼]] [[등락률%]] · [[등락포인트]]pt</div>
      <div class="sub" style="margin-top:8px;">외국인 [[순매수|순매도]] <strong style="color:var(--[[up|down]]);">[[금액]]억</strong> · 기관 [[순매수|순매도]] [[금액]]억</div>
      <div class="sub">[[KOSDAQ 특이사항 — 바이오/2차전지/AI 섹터 동향]]</div>
    </div>
  </div>
  <!-- 한국 섹터 동향 -->
  <div class="card" style="margin-bottom:14px;">
    ...
    <div style="display:grid; grid-template-columns:repeat(3,1fr); gap:8px;">
      <div style="background:#0d1117; border-radius:8px; padding:10px; border:1px solid var(--border);">
        <div style="font-size:0.68rem; color:var(--muted); margin-bottom:4px;">강세 섹터</div>
      ...
      <div style="background:#0d1117; border-radius:8px; padding:10px; border:1px solid var(--border);">
        <div style="font-size:0.68rem; color:var(--muted); margin-bottom:4px;">약세 섹터</div>
      ...
      <div style="background:#0d1117; border-radius:8px; padding:10px; border:1px solid var(--border);">
        <div style="font-size:0.68rem; color:var(--muted); margin-bottom:4px;">주요 종목 동향</div>
        <div style="font-size:0.78rem; color:var(--text);">[[삼성전자 등 시총 상위 주요 종목 등락]]</div>
      </div>
    </div>
  </div>
  <!-- 한국 증시 리스크 -->
  <div class="card" style="margin-bottom:14px;">
    <div style="font-size:0.78rem; font-weight:700; color:var(--warn); margin-bottom:10px;">⚠️ 한국 증시 예상 리스크</div>
    <div class="risk-grid">
      <div class="risk-item"><div class="dot [[dot-red|dot-yellow|dot-green]]"></div><div><div class="risk-label">① 환율 리스크</div><div class="risk-desc">[[USD/KRW 현재값]] · [[원화 약세/강세 원인]] · [[코스피 외국인 수급에 미치는 영향]]</div></div></div>
      <div class="risk-item"><div class="dot [[dot-red|dot-yellow|dot-green]]"></div><div><div class="risk-label">② 반도체/수출 리스크</div><div class="risk-desc">[[삼성/SK하이닉스 최근 이슈]] · [[수출 증감률]] · [[미중 무역/기술 규제 영향]]</div></div></div>
      <div class="risk-item"><div class="dot [[dot-red|dot-yellow|dot-green]]"></div><div><div class="risk-label">③ 외국인 수급 리스크</div><div class="risk-desc">[[최근 N일 외국인 누적 순매수/도]] · [[이탈/유입 원인]] · [[단기 전망]]</div></div></div>
      <div class="risk-item"><div class="dot [[dot-red|dot-yellow|dot-green]]"></div><div><div class="risk-label">④ 매크로 연계 리스크</div><div class="risk-desc">[[미 금리·달러·중국 경기와 코스피 연계]] · [[구체적 수치+영향도]]</div></div></div>
    </div>
  </div>
  <!-- 한국 증시 투자 준비사항 -->
  <div style="background:rgba(88,166,255,0.06); border:1px solid rgba(88,166,255,0.25); border-radius:12px; padding:16px 18px;">
    <div style="font-size:0.78rem; font-weight:700; color:var(--accent); margin-bottom:10px;">📋 한국 주식 투자자 향후 준비사항</div>
    <div style="display:grid; grid-template-columns:repeat(2,1fr); gap:10px;">
      <div>
        <div style="font-size:0.7rem; color:var(--warn); font-weight:700; margin-bottom:6px;">📌 단기 주목 이벤트 (1~2주)</div>
        <div style="font-size:0.78rem; color:var(--text); line-height:1.7;">[[날짜+이벤트+코스피 임팩트 예상 — 실적발표, 지수 리밸런싱, 공매도 관련 등]]</div>
      </div>
      <div>
        <div style="font-size:0.7rem; color:var(--down); font-weight:700; margin-bottom:6px;">🛡️ 지금 챙겨야 할 포지션</div>
        <div style="font-size:0.78rem; color:var(--text); line-height:1.7;">[[지금 한국 주식 투자자가 취해야 할 구체적 포지션 및 대응 전략 — 수급/섹터/환율 기반]]</div>
      </div>
    </div>
    <div style="margin-top:10px; padding-top:10px; border-top:1px solid var(--border); font-size:0.78rem; color:var(--muted); line-height:1.7;">
      💡 <strong style="color:var(--text);">최신 정보:</strong> [[오늘자 한국 증시 관련 핵심 뉴스 2~3줄 — 출처 포함]]
    </div>
  </div>
</div>
...
==========================================================
[STEP 2] 웹 검색 — 아래 5개만 실행 (JSON에 없는 데이터)
==========================================================
...
4. "코스피 코스닥 외국인 기관 수급 [[TODAY]]" → 외국인/기관 순매수(도) 금액, 주요 수급 종목
5. "한국 주식시장 리스크 전망 [[TODAY]]" → 한국 증시 특화 이슈 (환율, 수출, 반도체, 정치 등)
